...
const suggestedActions = [
    {
        ...
        action: 'Show me a list of all machine id , its machine type and the status of the machine.',
    },
    {
        title: 'Show chart of',
...
export const ChatInput = ({ question, setQuestion, onSubmit, isLoading, showSuggestions = false }: ChatInputProps) => {
